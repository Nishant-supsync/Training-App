...
type TabType = 'upload' | 'providers';
type SubTabType = 'upload' | 'history';
...
export default function InspectionCertificatesScreen() {
  ...
  const SubTabBar = () => (
    <View className="flex-row px-4 py-2 bg-white">
      <TouchableOpacity 
        className={`px-6 py-2 rounded-full ${subTab === 'upload' ? 'bg-blue-500' : 'bg-gray-100'}`}
        onPress={() => setSubTab('upload')}
      >
        <Text className={subTab === 'upload' ? 'text-white' : 'text-gray-600'}>Upload</Text>
      </TouchableOpacity>
      <TouchableOpacity 
        className={`px-6 py-2 rounded-full ml-2 ${subTab === 'history' ? 'bg-blue-500' : 'bg-gray-100'}`}
        onPress={() => setSubTab('history')}
      >
        <Text className={subTab === 'history' ? 'text-white' : 'text-gray-600'}>History</Text>
      </TouchableOpacity>
    </View>
  );
  ...
  const ServiceProviderList = () => (
    <ScrollView className="flex-1 p-4">
      <View className="flex-row items-center bg-white rounded-lg px-4 mb-4 border border-gray-200">
    ...
    <ScrollView className="flex-1 p-4">
      <View className="mb-4">
        ...
        <TouchableOpacity className="bg-white border border-gray-200 rounded-lg p-4">
          <Text className="text-gray-400">Select the type of certificate</Text>
        </TouchableOpacity>
      </View>
      ...
      <View className="mb-4">
        ...
        <TouchableOpacity className="bg-white border border-gray-200 rounded-lg p-4">
          <Text className="text-gray-400">MM/DD/YY</Text>
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity className="bg-blue-500 rounded-lg p-4 mt-6">
  ...
  const HistoryList = () => (
    <ScrollView className="flex-1 p-4">
      ...
      <TouchableOpacity className="bg-blue-500 rounded-lg p-4 mt-4">
        <Text className="text-white text-center font-medium">Upload Certificate</Text>
      </TouchableOpacity>
    </ScrollView>
  );
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      <Header />
      <TabBar />
      {mainTab === 'upload' && <SubTabBar />}
      
      {mainTab === 'providers' ? (
        <ServiceProviderList />
      ) : (
        subTab === 'upload' ? <UploadForm /> : <HistoryList />
      )}
